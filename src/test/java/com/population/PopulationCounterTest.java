 ...
 */
import com.population.PopulationCounter;
...
public class PopulationCounterTest {
    ...
    public void testSomeLibraryMethod() throws Exception {
        ...
        // Exercise
        String output = PopulationCounter.getPopulation("./data/worldcitiespop.csv");
    ...
    @Test
    public void throwsExceptionWhenFileNotPresent() {
